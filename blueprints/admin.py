...
from auth_store import extract_token, is_admin_token
from helpers import render_template_text, infer_difficulty
from models import db, Email, UserAction, Template, Target, Campaign, CampaignTarget, SmsAction
...
def api_sms_user_reports():
    ...
    from helpers import load_sms_messages
